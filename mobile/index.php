...
//判断openid是否存在session中 
// session_start();
//unset($_SESSION['openid']);
// if($openid != null && !session_is_registered('openid')){
...
<!--     <base target="_blank" /> -->
  ...
  <!-- banner栏 -->
  <div class="banner">
    <img class="banner-img" src="/mobile/img/banner-1.jpg" alt="">
  </div>
  
  <!-- 标签栏 
  <div class="idx-guide comWidth">
    <div class="idx-col">
      <span class="glyphicon glyphicon-film idx-gly" aria-hidden="true"></span><span class="idx-span">&nbsp;海量视频</span>
    </div>
    <div class="idx-col">
      <span class="glyphicon glyphicon-thumbs-up idx-gly" aria-hidden="true"></span><span class="idx-span">&nbsp;专业教学</span>
    </div>
    <div class="idx-col">
      <span class="glyphicon glyphicon-comment idx-gly" aria-hidden="true"></span><span class="idx-span">&nbsp;需求咨询</span>
    </div>
  </div>-->
  <div class="idx-guide comWidth">
    <div class="idx-col">
      <img src="/mobile/img/nav-3.png"/>
      <i>快</i>
    </div>
    <div class="idx-col">
      <img src="/mobile/img/nav-2.png"/>
      <i>好玩</i>
    </div>
    <div class="idx-col">
      <img src="/mobile/img/nav-1.png"/>
      <i>专业</i>
    </div>
  </div>

            ...
            <div class="search">
                ...
                <div class="center">
                        ...
                        <div class="po">
                            ...
                            <div class="pro_from">
                            	<form action="/products.php" method="get">
                                	<input style="text-indent:10px;font-size: 16px;" type="text" name="P0"  value="<?=($P0 || $P1) ? $P0 : ''?>" />
                                    -
                                    <input style="text-indent:10px;font-size: 16px;" type="text" name="P1" value="<?=($P0 || $P1) ? $P1 : ''?>"  />
                            </div>
                            		<span class="fl"><img src="/images/pro_list_line.jpg"  /></span>
                    ...
                    <div class="Teachsearch">
                    	<form action="/products.php" method="get">
                        	<input style="color:#828282;font-size: 16px;" type="text" name="Keyword" class="input_left" value="<?=isset($Keyword) ?  $Keyword : '输入老师姓名或者ID...'?>" onfocus="javascript:if(this.value=='输入老师姓名或者ID...')this.value='';">
...
<?php 
    if($_GET['page']==1||$_GET['page']==''){
        echo "$('.page_button:eq(0)').css({display:'none'})";
    }
    if($_GET['page']==$total_pages){
        echo "$('.page_button:eq(1)').css({display:'none'});";
    }
 ?> 
</script> 
</html>
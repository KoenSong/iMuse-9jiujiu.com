...
function Calendar(beginYear, endYear){
	...
	this.form=null;
	console.info(this.getElementById('calendarPanel'));
	this.date=new Date();
...
document.write('<div id="ContainerPanel" style="display:none;"><div id="calendarPanel" style="position:absolute; display:none; z-index:1000000;');
document.write('background:#fff; border:1px solid #ccc; width:175px; font-size:12px;"></div>');
if(document.all)
{

...
function pop_info_tips(tips){	//弹出信息
	...
	pop_info_tips.style.cssText='position:absolute; z-index:100001; border:4px solid #333; background:#fff; left:0px; top:0px; width:550px;';
...
function add_wholesale_class_item(obj){
	var newrow=$_(obj).insertRow(-1);
	newcell=newrow.insertCell(-1);
	newcell.innerHTML='&nbsp;&nbsp;&nbsp;课程:&nbsp;&nbsp;'+'<select name="Issue_D[]" onchange="checktime()"><option value="1">星期一</option><option value="2">星期二</option><option value="3">星期三</option><option value="4">星期四</option><option value="5">星期五</option><option value="6">星期六</option><option value="7">星期日</option></select>&nbsp;&nbsp;&nbsp;上课时间&nbsp;<select name="Issue_T[]"><option value="1">早上</option><option value="2">下午</option><option value="3">晚上</option></select>&nbsp;&nbsp;&nbsp;时长:<input type="text" class="form_input" name="Issue_L[]"onkeyup="set_number(this, 0);" onpaste="set_number(this, 0);" /><a href="javascript:void(0)" onclick="$_(\'wholesale_price_list\').deleteRow(this.parentNode.parentNode.rowIndex);"><img src="../images/del.gif" hspace="5" /></a><div class="blank15"></div>';
}
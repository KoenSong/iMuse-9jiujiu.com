...
if($_POST['module']=='add'){
	...
	$SumTime=(int)$_POST['SumTime'];
	$JumpUrl=$_POST['JumpUrl'];
}else{
	$ProId=(int)$_GET['ProId'];
	$SumTime=(int)$_GET['SumTime'];
...
if(!$db->get_row_count('shopping_cart', $where)){
	$db->insert('shopping_cart', array(
			...
			'PicPath'	=>	str_replace('s_','105X105_',$product_row['PicPath_0']),
...
='{$product_row['ColorId']}'",'Color')?></span>
        ...
        <div>
            ...
            <input type="submit" class="btn-orig" style="padding:0 65px;width:270px; border:0px; outline:0;" value="提交约课">

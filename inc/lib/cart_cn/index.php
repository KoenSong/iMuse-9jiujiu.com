...
$login_module_ary=array('checkout', 'place', 'payment', 'complete', 'get_shipping_methods', 'set_payment_method','payment_two');	//需要登录的模块列表
...
if((int)$_SESSION['member_MemberId']){	//已登录
	...
	js_location("/account.php?module=login",'请先登录会员');

...
if($verify_result) {//验证成功
	...
	$db->update('order_three', "OId='$OId'", array(
			'OrderStatus'	=>	2,
...
ob_end_clean();
	...
	write_file($save_dir='/_recharge_log/'.date('Y_m/d/', $service_time),$save_name="recharge_notify-{$OId}.txt", $contents=$log);

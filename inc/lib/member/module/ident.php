		...
		<div class="form lib_member_item_card">
			<form action="/inc/lib/member/action/mod.php" method="post"  name="member_profile_form" enctype="multipart/form-data" OnSubmit="return checkForm(this);">
                ...
                <div class="rows">
                    ...
                    <span>
						<input type="file" class="form_input" name="Pic_Cer" />
                        <br /><br />
                    ...
                    <div class="IDpic fr" style="width:450px">
                        <div style="width:230px; float:left;" class="PicPath">
                            <img  src="images/IDpic.jpg" style="width:230px;" alt=""> 
                            <div style="height:30px;line-height:20px;text-align:center;font-size:14px; ">(参考实例)</div>
                        </div>
                        <div style="width:200px; line-height:25px;font-size:14px; float:right;">身份证上的所有信息清晰可见，必须能看清证件号，照片需免冠，建议未化妆，手持证件人五官清晰可见，照片内容真实有效，不得做任何修改支持 .jpg .png格式照片大小不超过2M。</div>
                        <div class="clear"></div>
                    </div>
                    <div class="clear"></div>
                </div>

...
#register{width:885px;height:585px;margin:0 auto;background:#fff;border-radius:10px;margin-top:100px;position:relative;}
...
.showcy li span{display:block;text-align:center;color:#818181;-moz-transition:all .2s ease-in-out;-webkit-transition:all .2s ease-in-out;-ms-transition:all .2s ease-in-out;transition:all .2s ease-in-out;width:70px;height:24px;border:1px solid #d7d7d7;cursor:pointer;}
.showcy li span:hover{color:#fff;background-color:#FF921E;border-color:transparent;cursor:pointer;}
.showcy li span.hover{color:#fff;background-color:#FF921E;border-color:transparent;cursor:pointer;}
...
.site_nav{height:30px;border-bottom:1px solid #ddd;background:#f4f4f4;line-height:30px;z-index:10000;width:100%;}
...
.mian_nav{height:50px;line-height:50px;background:#6694dd;position:relative;z-index:2;}
.mian_nav h2,.mian_nav h3{color:#fff;font-size:18px;width:230px;text-align:left;padding-left:30px;background-color:#518cd5;position:relative;cursor:pointer;font-weight:bold;}
.mian_nav h2.up:after{background-position:-46px -41px;}
.mian_nav h2:after,.mian_nav h3:after{content:'\20';background:url(/img/newui/ico2_9.png) no-repeat 0px -41px;position:absolute;padding:10px;right:22px;margin-top:-12px;top:50%;}
.mian_nav .nav_all{color:#fff;background:#518cd5;padding-left:15px;display:none;}
.mian_nav div.mycenter{width:1200px;margin:0 auto;position:relative;}
.mian_nav .sub_nav:hover dl{display:block;}
.mian_nav .sub_nav{width:230px;background:#518cd5;z-index:999;position:absolute;}
.mian_nav .sub_nav li dl{position:absolute;left:230px;top:0px;width:733px;background:url(/img/newui/bg-showright.png);display:none;padding:12px 10px;border:2px solid #5a8ad7;height:100%;}
...
.mian_nav .sub_nav dd{float:left;height:25px;line-height:25px;width:570px;text-align:left;color:#D7D7D7;}
...
.hls_search{float:left;margin-left:90px;margin-right:80px;padding-top:8px;}
.hls_search:after{clear:both;display:table;content:'\20';}
.hls_search input{height:45px;line-height:normal;line-height:45px\9;border:1px solid #ccc;width:368px;padding:0 10px 0 20px;font-size:14px;border-right:none;outline:0;transition:border-color .3s linear;-moz-transition:border-color .3s linear;-ms-transition:border-color .3s linear;-webkit-transition:border-color .3s linear;float:left;background-color:#F9F9F9;border-radius:0;}
.hls_search input:focus{border-color:#6694DD;background-color:#fff;}
.hls_search .hls_sou{background:#6694dd;height:45px;line-height:45px;color:#fff;display:inline-block;padding:0 20px 0 25px;word-spacing:5px;letter-spacing:5px;cursor:pointer;}
.hls_stern{padding-top:8px;}
.hls_stern li{float:left;width:50px;font-size:12px;margin:0 20px 0 20px;text-align:center;}
.hls_stern li a{display:inline-block;padding-top:30px;color:#b8b8b8;background:url(/img/newui/ico2_9.png) no-repeat;}
.hls_stern li a.stern_1{background-position:4px 0;}
.hls_stern li a.stern_2{background-position:-79px 0;}
.hls_stern li a.stern_3{background-position:-162px 0;}
.hls_grade{font-size:14px;color:#fff;font-weight:bold;display:inline-block;width:180px;height:25px;line-height:25px;float:left;text-align:left;margin-top:18px;padding-left:15px;}
.hls_subjects{font-size:12px;margin-right:18px;display:inline-block;width:180px;line-height:12px;float:left;text-align:left;padding-bottom:15px;border-bottom:1px dashed #fff;padding-left:15px;white-space:nowrap;}
...
.nav_box{float:left;position:absolute;z-index:3;top:0px;left:230px;height:50px;line-height:50px;}
.nav_box ul li{list-style:none;float:left;margin:0 32px;height:50px;}
.nav_box ul li:hover{border-bottom:5px solid #5181d5;height:50px;}
.nav_box ul li a{margin:0 4px;color:#fff;height:50px;display:inline-block;font-size:16px;transition:font-weight .3s ease-out;-webkit-transition:font-weight .3s ease-out;-moz-transition:font-weight .3s ease-out;-ms-transition:font-weight .3s ease-out;}
.nav_box ul li a:hover{text-decoration:none;font-weight:bold;}
.nav_box ul li.cur a{font-weight:bold;}
.nav_box ul li.cur{border-bottom:5px solid #5181d5;}
.nav_box ul li.last{font-family:\5b8b\4f53;font-size:12px;padding-top:1px;}
.nav_box ul li.last a{color:#a2a2a1;}
.hls_slogan{background:url(/img/newui/ico2_9.png) no-repeat 0px -72px;height:50px;width:150px;position:absolute;right:15px;top:0;display:none;}
.nav_right{position:absolute;right:0px;top:0;}
.nav_right li{float:left;margin-left:8px;}
.nav_right li a{display:inline-block;padding:0 15px;height:30px;line-height:30px;border-radius:5px;}
.nav_right li a.white{background:#fff;color:#808080;}
.nav_right li a.yellow{background:#ff921e;color:#fff;}
...
.page-yk{position:absolute;left:0;right:0;top:0;bottom:0;z-index:1000;width:100%;height:100%;opacity:1;display:none;}
.poptrox-popup{background:#fff;-moz-box-sizing:content-box;-webkit-box-sizing:content-box;-o-box-sizing:content-box;-ms-box-sizing:content-box;box-sizing:content-box;padding-bottom:3em;}
.bg-r-c-s{position:fixed;opacity:0.75;background-color:#0a1919;filter:alpha(opacity=75);left:0;top:0;width:100%;height:100%;}
#styk,#yk{text-align:center;}
.yk-hls{margin-top:30px;}
...
.flou > label{display:inline-block;text-align:right;font-size:15px;width:126px;color:rgb(97,97,97);margin-top:12px;text-shadow:none;}
...
.gradeUI{color:rgb(100,100,100);letter-spacing:0.25em;-moz-transition:all .25s ease-in-out;-webkit-transition:all .25s ease-in-out;-o-transition:all .25s ease-in-out;-ms-transition:all .25s ease-in-out;transition:all .25s ease-in-out;outline:0;background-color:#fff;border:3px solid #fff;text-align:left;padding:8px 18px;font-size:14px;background:#fff url(/images/sprite-search.png?v=02) no-repeat;background-position:right -214px;cursor:pointer;position:relative;box-shadow:inset 0px 0px 1px 1px rgba(255,255,255,0.25);-moz-transition:all .25s ease-in-out;-webkit-transition:all .25s ease-in-out;-o-transition:all .25s ease-in-out;-ms-transition:all .25s ease-in-out;transition:all .25s ease-in-out;}
...
.hope_subject{float:left;width:420px;margin-top:17px;margin-left:5px;}
...
<div class="page-yk" id="yk" style="display:block">
    <div class="bg-r-c-s">&nbsp;</div>
    <div class="poptrox-popup overfl-pop">
        <h1>完善信息，快速找到好老师</h1>
        <div class="yk-hls">
            <div class="flou clear-fx">
                <label><i class="rd0">*</i>期望上课地点：</label>
                <div class="inp-si" id="uide">
                    <div class="gradeUI widada" id="gui-qu0"><?= $alter_city[0]['Color']?>
                        <div class="adb" style="overflow: hidden;">
                            <ul id="w_city">
                            <?php
							 
                           	 foreach((array) $alter_city as $item){
								?>
                                <li><a data="<?=$item['CId']?>" href="javascript:void(0);"><?=$item['Color']?></a></li>
                             <?php }?>
                            </ul><input type="hidden" id="CId" value="">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="flou clear-fx">
                <label><i class="rd0">*</i>学生昵称：</label>
                <div class="inp-si">
                    <input id="stu_name" type="text" placeholder="比如：莎莎" style="display:inline-block;">
                </div>
            </div>
            <div class="flou clear-fx">
                <label><!-- <i class="rd0">*</i> -->学生性别：</label>
                <div class="inp-si">
                    <label for="male"><input type="radio" name="gender" id="male" value="1">男</label>
                    <label for="female"><input type="radio" name="gender" id="female" value="2">女</label>
                </div>
            </div>
            <!-- <div class="flou clear-fx" style="margin: 10px 0 18px 0;">
                <label><i class="rd0">*</i>与孩子的关系：</label>
                <div class="inp-si fmsi">
                    <label for="father"><input type="radio" name="rship" id="father" value="1">爸爸</label>
                    <label for="mother"><input type="radio" name="rship" id="mother" value="2">妈妈</label>
                    <label for="fm"><input type="radio" name="rship" id="fm" value="3">其他</label>
                </div>
            </div> -->
            <div class="flou clear-fx">
                <label><!--<i class="rd0">*</i>-->学生所在学校：</label>
                <div class="inp-si">
                    <input id="txt_school" type="text" placeholder="比如：中关村第二小学" style="display:inline-block;">
                </div>
            </div>
            <div class="flou clear-fx">
                <label><i class="rd0">*</i>学生所在年级：</label>
                <div class="inp-si" id="uide">
                    <div class="gradeUI" style="width:390px; padding: 8px 24px 8px 12px;" id="gui-qu2">请选择
                        <div class="adb" style="height: 150px; overflow: hidden;">
                            <ul>
                             <li><a title="" data="1" href="javascript:;">小学一年级</a></li>
                            </ul><input type="hidden" id="txt_grade" value="0">
                        </div>
                    </div>
                </div>
            </div>
			<div class="flou clear-fx">
                <label class="hope_txt"><!-- <i class="rd0">*</i> -->希望补习的科目：<br>(可多选)　　　</label>
				<ul class="hope_subject">
					<li><label for="chinese"><input type="checkbox" name="chinese" id="chinese" value="1">语文</label></li>
				</ul>
            </div>
            <p style="color: rgb(248, 20, 20); margin:18px 0 36px;">*以上信息仅用于向老师约课，365好老师将严格为您保护好孩子的隐私</p>
        </div>
        <div class="btn-yk">
            <div class="warn-yk-proto clear-fx">
                <a href="javascript:void(0);" class="btn-orig" onclick="submit_b();">确定</a>
            </div>
        </div>
		        <p style="width:240px; text-align:center;" class="errorMSG" id="errorMSG_ws">您目前已预约数学科目的老师，暂时无法继续预约该科目老师。请您安排好时间与已约老师进行试听。</p>
    </div>
</div>
<?php /*?><div id="lib_member_login">
	<?php if($_GET['login_fail']==1){?>
		<div class="lib_member_msgerror"><img src="/images/lib/member/msg_error.png" align="absmiddle" />&nbsp;&nbsp;登陆失败，请重新尝试。</div>
	<?php }?>
    
	<div class="lib_member_title">用户注册 <a href="<?=$member_url_cn.'?'.query_string(array('login_fail', 'module'));?>&module=login" title="注册新账号" class="fr login_create">去登录</a></div>
    <div class="blank33"></div>
    
    <div class="lft fl">
    <form action="/inc/lib/member/action/mod.php" method="post" name="member_create_form" OnSubmit="return checkForm(this);">
    	<div class="item">
            <span class="item_name fl">申请类型：</span>
            <select name="Apply" class="sex fl">
            	<option value="0">学生会员</option>
            	<option value="1">老师会员</option>
            </select>
        </div>
        
        <div class="item">
            <span class="item_name fl">性别：</span>
            <select name="Title" class="sex fl">
        ...
        <div class="item">
            <span class="item_name fl"><span class="c_red">*</span>姓氏：</span>
            <input name="FirstName" value="" type="text" class="block user login_item fr" size="41" maxlength="100" check="请输入用户名!~*" >
        </div>
        <div class="item">
            <span class="item_name fl"><span class="c_red">*</span>名字：</span>
            <input name="LastName" value="" type="text" class="block user login_item fr" size="41" maxlength="100" check="请输入用户名!~*" >
        </div>
        <div class="item">
            <span class="item_name fl"><span class="c_red">*</span>邮箱：</span>
            <input name="Email" value="" type="text" class="block user login_item fr" size="41" maxlength="100" check="请输入邮箱!~email|邮箱格式不正确!*" >
        </div>
        <div class="item">
            <span class="item_name fl"><span class="c_red">*</span>密码：</span>
         	<input name="Password"  type="password" class="block pwd login_item fr" size="41" maxlength="20" check="请输入密码!~*">
        </div>
       
        <div class="item">
            <span class="item_name fl"><span class="c_red">*</span>确定密码：</span>
         	<input name="ConfirmEmail" type="password" class="block pwd login_item fr" size="41" maxlength="20" check="请输入确定密码!~*">
        </div>
        <div class="item">
            <span class="item_name fl"><span class="c_red">*</span>地区：</span>
            <span class="area">
            <select name="Country" check="请正确填写所在省份!~*"></select>
            <select name="State" check="请正确填写所在市区!~*"></select>
            <select name="City" check="请正确填写所在区域!~*"></select>
            <script type="text/javascript" src="/js/china_area.js"></script> 
            <script language=javascript>
                new PCAS('Country', 'State', 'City', '', '', '')
            </script>
            </span>
        </div>

        <div class="item">
            <span class="item_name fl"></span>
         	
            <div class="item_confirm fr">
            	<input type="checkbox" id="box_confirm" sta='0'/> 我已阅读并接受<a href="javascript://" class="m_color">《注册协议》</a>
            	<div class="blank20"></div>
                <input type="submit" name="Submit" value="立即注册" class="block login_sub">
                <input type="hidden" name="data" value="member_create" />
                <input type="hidden" value="" id="box" check="请确定注册协议!~*"/>
            </div>
        </div>
    ...
    <div class="rig fr"><?=$db->get_value('article','AId=4','Contents');?></div> <!-- 注册协议 -->
</div>

<script type="text/javascript">

	jQuery('.login_item').hover(
		function(){
	...
	jQuery('#box_confirm').click(
		function(){
			sta = parseInt(jQuery(this).attr('sta'));
			if(sta){
				jQuery('#box').val('');
				jQuery(this).attr('sta','0');
			}else{
				jQuery('#box').val('1');
				jQuery(this).attr('sta','1');
			}
		}
	)

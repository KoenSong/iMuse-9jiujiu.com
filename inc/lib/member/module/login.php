...
<div id="lib_member_login" class="over">
	...
	<?php /*?><div class="lib_member_title">用户登录 <a href="<?=$member_url_cn.'?'.query_string(array('login_fail', 'module'));?>&module=create" title="注册新账号" class="fr login_create">注册新账号</a></div><?php */?>
    ...
    <div class="member_crt margin0">
        ...
        <div class="blank20"></div>
         <div class="blank20"></div>
        <form action="/inc/lib/member/action/mod.php" method="post" name="member_login_form" OnSubmit="return checkForm(this);">
            <?php /*?><span class="t">手机号或ID号：</span><?php */?>
            <div class="row">

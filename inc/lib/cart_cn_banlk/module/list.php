			...
			<div class="cart">
				<table width="100%" border="0" cellpadding="0" cellspacing="0" class="item_list_table">
					...
					<tr class="item_list item_list_out" onmouseover="this.className='item_list item_list_over';" onmouseout="this.className='item_list item_list_out';">
						...
						<td valign="top"><a href="<?=$cart_row[$i]['Url'];?>" target="_blank" class="proname"><?=$cart_row[$i]['ItemNumber'];?></a><?php if($order_product_weight==1){?><br /><span style="font-size:12px;">重量: <?=$cart_row[$i]['Weight'];?> KG<?php }?></span></td>
						<td valign="top">

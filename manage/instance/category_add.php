...
<table width="100%" border="0" cellpadding="0" cellspacing="1" id="mouse_trBgcolor_table">
	...
	<?php if(get_cfg('instance.category.dept')>1){?>
		<tr>
			...
			<td><?=ouput_Category_to_Select('UnderTheCateId', $db->get_value('manage_operation_log', 'Operation="instance_category_add"', 'Value'), 'instance_category', 'UId="0,"', 'Dept<'.get_cfg('instance.category.dept'), get_lang('ly200.select'));?></td>
		</tr>
	<?php }?>

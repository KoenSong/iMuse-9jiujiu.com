...
<table width="100%" border="0" cellpadding="0" cellspacing="1" id="mouse_trBgcolor_table">
	...
	<tr>
		<td nowrap>手机号:</td>
		<td><?=htmlspecialchars($product_review_row['Phone']);?></td>
	</tr>
	<tr>
		<td nowrap>评论分:</td>
		<td><?php if($product_review_row['Review_Level']==5){echo '好评';}elseif($product_review_row['Review_Level']==2){echo '中评';}elseif($product_review_row['Review_Level']==-1){ echo '差评';}?></td>
	</tr>
	<tr>

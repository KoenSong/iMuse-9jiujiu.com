...
<table width="100%" border="0" cellpadding="0" cellspacing="1" id="mouse_trBgcolor_table" not_mouse_trBgcolor_tr='list_form_title'>
	...
	<tr align="center">
		...
		<td><?=htmlspecialchars($product_review_row[$i]['Phone']);?></td>
		<td nowrap><?php if($product_review_row[$i]['Review_Level']==5){echo '好评';}elseif($product_review_row[$i]['Review_Level']==2){echo '中评';}elseif($product_review_row[$i]['Review_Level']==-1){ echo '差评';}?></td>
		...
		<td><a href="view.php?<?=$all_query_string;?>&RId=<?=$product_review_row[$i]['RId']?>"><img src="../images/view.gif" alt="<?=get_lang('ly200.view');?>" /></a></td>
	</tr>
	<?php }?>

...
$db->update('orders', "OrderStatus=5 and OrderTime+15*3600*24<$service_time", array(
		'OrderStatus'	=>	6
	)
);
...
$FullName && $where.=" and Shipping_Name like '%$FullName%'";
...
<table width="100%" border="0" cellpadding="0" cellspacing="1" id="mouse_trBgcolor_table" not_mouse_trBgcolor_tr='list_form_title'>
	...
	<tr align="center">
		...
		<?php if(get_cfg('orders.del')){?><td><input type="checkbox" name="select_OrderId[]" value="<?=$order_row[$i]['OrderId'];?>"></td><?php }?>
	...
	<?php }?>
	<?php if(get_cfg('orders.del') && count($order_row)){?>
	<tr>

...
$module_ary=array('base', 'status', 'product_list', 'product_add', 'print', 'export','memberinfo');	//模块列表
...
?>
<div class="header"><?=get_lang('ly200.current_location');?>:<a href="index.php"><?=get_lang('orders.orders_manage');?></a>&nbsp;-&gt;&nbsp;<a href="view.php?OrderId=<?=$OrderId;?>"><?=$order_row['OId'];?></a>&nbsp;-&gt;&nbsp;<?=get_lang('ly200.view');?></div>

	...
	if($log_excode!=$_SESSION[md5('manage')] || $_SESSION[md5('manage')]==''){
		...
		if($user_info=$db->get_one('userinfo', "UserName='$username'")){		
			if($user_info['Locked']){
				...
				$_SESSION['ly200_AdminUserId']=(int)$user_info['UserId'];
				...
				$_SESSION['ly200_AdminGroupId']=(int)$user_info['GroupId'];
	...
	<div class="login_form_div">
		<form action="index.php" method="post" name="login_form" id="login_form" onSubmit="return login(this);">
			<table width="100%" border="0" align="center" cellpadding="0" cellspacing="5">
			  <tr>
				<td height="30"></td>
				<td colspan="2" class="fz_14px fc_red" valign="top"><?=$_SESSION['ly200_AdminLoginTips'];?></td>
			  </tr>
			  <tr>

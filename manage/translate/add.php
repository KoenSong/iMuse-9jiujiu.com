...
?>
<div class="header"><?=get_lang('ly200.current_location');?>:<a href="index.php"><?=get_lang('translate.translate_manage');?></a>&nbsp;-&gt;&nbsp;<?=get_lang('ly200.add');?></div>
...
<table width="100%" border="0" cellpadding="0" cellspacing="1" id="mouse_trBgcolor_table">
	...
	<?php /*?><tr>
		...
		<td><input name="Url" type="text" value="" class="form_input" size='60' maxlength="100" check="<?=get_lang('ly200.filled_out').get_lang('translate.url');?>!~*"></td>
	</tr><?php */?>

					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
					  <tr>
						...
						<td valign="top" class="flh_150" style="padding-left:10px;">
							...
							<?php if($menu['member']){?><input type="checkbox" name="AllMember" value="1"><?=get_lang('send_mail.send_to_all_member');?><br /><?php }?>
							<?php if($menu['newsletter']){?><input type="checkbox" name="AllNewsletter" value="1"><?=get_lang('send_mail.send_to_all_newsletter');?><?php }?>
						</td>
					  </tr>
					</table>
				</td>

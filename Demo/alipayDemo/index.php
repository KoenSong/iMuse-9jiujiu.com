            ...
            <div id="body" style="clear:left">
                <dl class="content">
                    ...
                    <dd>
                        ...
                        <input size="30" name="WIDout_trade_no" value="a123"/>
                    ...
                    <dd>
                        <span class="null-star">*</span>
                        <input size="30" name="WIDsubject" value="a测试产品" />
                        <span>必填
</span>
                    </dd>
                    <dt>付款金额：</dt>
...
：</dt>
                    <dd>
                        <span class="null-star">*</span>
                        <input size="30" name="WIDbody" value="测试产品-快捷支付接口"/>
                        <span></span>
                    </dd>
                    <dt>商品展示地址：</dt>
                    <dd>
                        <span class="null-star">*</span>
                        <input size="30" name="WIDshow_url" value="http://9jiujiu.com/Demo/echo.php"/>

...
<body>  
	<form action="#" method="post">
        ...
        <input type="text" style="width:96%;height:35px;margin-left:2%;" name="transaction_id" value="1007690657201601142695132812"/><br /><br />
        <div style="margin-left:2%;">商户订单号：</div><br/>
        <input type="text" style="width:96%;height:35px;margin-left:2%;" name="out_trade_no" value="123997890220160114164300"/><br /><br />

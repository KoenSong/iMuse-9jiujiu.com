<?php 
    ...
    */ 
    ...
    echo 'Long to Short: '.bdUrlAPI(1, 'https://open.weixin.qq.com/connect/oauth2/authorize?appid=wxf2bd74751985d977&redirect_uri=http://9jiujiu.com/mobile/index.php?response_type=code&scope=snsapi_base&state=1#wechat_redirect').'<br/>'; 
